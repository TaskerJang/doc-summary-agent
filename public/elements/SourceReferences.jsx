...
function SourceItem({ source }) {
  const { index = 1, section = "", snippet = "", fullChunk = "" } = source || {};
  ...
  // full_chunk가 없으면 호버/클릭 인터랙션 없이 평범한 출처 항목으로만 렌더
  // (overall fallback 경로 등에서 발생하는 엣지케이스 방어)
  ...
  return (
    <li className="list-none">
      <HoverCard openDelay={250} closeDelay={150}>
        ...
        <HoverCardContent side="top" align="start" className="w-[420px] max-w-[90vw]">
